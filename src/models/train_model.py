...
y_test.value_counts().plot(kind="bar", ax=ax, color="orange", label="Test")
plt.legend()
plt.show()
...
# Save score_df
score_df.to_pickle("../../data/processed/01_model_scores.pkl")

# --------------------------------------------------------------
# Create a grouped bar plot to compare the results
# --------------------------------------------------------------

score_df.sort_vales(by="accuracy", ascending=False)
...
plt.xlabel("Predicted label")
plt.grid(False)
plt.savefig("../../reports/figures/confusion_matrix_rf.png", dpi=300)
plt.show()
...
plt.xlabel("Predicted label")
plt.grid(False)
plt.savefig("../../reports/figures/confusion_matrix_fnn.png", dpi=300)
plt.show()
